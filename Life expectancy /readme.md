...
- Jupyter Notebooks (ZIP): Incluye todos los pasos del análisis, desde la limpieza de datos hasta la construcción de los modelos de machine learning y las conclusiones finales.
